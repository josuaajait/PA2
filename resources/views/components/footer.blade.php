        ...
        <div class="row">
            ...
            <div class="col-md-2 col-sm-6 mb-4">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2"><a href="{{ route('branding.home') }}" class="text-secondary text-decoration-none">Home</a></li>
                    <li class="mb-2"><a href="{{ route('branding.about') }}" class="text-secondary text-decoration-none">About Us</a></li>
                    <li class="mb-2"><a href="{{ route('branding.menu') }}" class="text-secondary text-decoration-none">Menu</a></li>
                    <li class="mb-2"><a href="{{ route('branding.pool') }}" class="text-secondary text-decoration-none">Pool</a></li>
                    <li class="mb-2"><a href="{{ route('branding.gallery') }}" class="text-secondary text-decoration-none">Gallery</a></li>
                </ul>
            </div>
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2"><a href="{{ route('branding.promos') }}" class="text-secondary text-decoration-none">Promos & Events</a></li>
                    <li class="mb-2"><a href="{{ route('branding.testimonials') }}" class="text-secondary text-decoration-none">Testimonials</a></li>
                    <li class="mb-2"><a href="{{ route('branding.contact') }}" class="text-secondary text-decoration-none">Contact Us</a></li>
                    <li class="mb-2"><a href="{{ route('reservation.table') }}" class="text-secondary text-decoration-none">Book a Table</a></li>
                    <li class="mb-2"><a href="{{ route('reservation.ticket') }}" class="text-secondary text-decoration-none">Buy Pool Ticket</a></li>
                </ul>
            </div>
