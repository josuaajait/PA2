...
@section('title', 'My Tickets - Caldera')
            ...
            <div class="card border-0 shadow-sm caldera-card">
                <div class="card-body text-center p-4">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="{{ route('customer.tickets') }}" class="btn btn-sidebar active">
            ...
            <div class="card border-0 shadow-sm caldera-card">
                <div class="card-header bg-transparent border-bottom-0 pt-4 px-4">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                        ...
                        <span class="badge" style="background: #f0ebe0; color: #1c3451; padding: 8px 16px; border-radius: 20px;">
                            <i class="fas fa-chart-line me-1"></i> Total: {{ $tickets->total() }} Tickets
                        </span>
                    </div>
                </div>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="ticket-item mb-3">
                        <div class="row align-items-center g-3">
                            ...
                            <div class="col-lg-2 col-md-12">
                                <a href="{{ route('reservation.ticket.view', $ticket->ticket_code) }}" 
                    ...
                    <div class="empty-state text-center py-5">
                        ...
                        <a href="{{ route('reservation.ticket') }}" class="btn btn-book">
