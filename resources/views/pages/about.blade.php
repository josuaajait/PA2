...
@section('title', 'About Us - Caldera Resto & Pool')
    ...
    <div class="row align-items-center mb-5">
        <div class="col-lg-6 mb-4 mb-lg-0">
            ...
            <div class="mt-4">
                ...
                <a href="{{ route('branding.menu') }}" class="btn btn-outline-caldera ms-2">
        ...
        <div class="col-lg-6">
            <div class="position-relative">
                <img src="{{ asset('storage/galleries/about.jpeg') }}" class="img-fluid rounded-4 shadow-lg" alt="About Caldera" style="width: 100%; object-fit: cover; height: 400px;">
            </div>
        </div>
    </div>
