                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="tel" name="customer_phone" class="form-control caldera-input" 
                                    placeholder="0812-3456-7890" value="{{ old('customer_phone') }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="number_of_guests" class="form-control caldera-input" 
                                    min="1" max="50" placeholder="2" value="{{ old('number_of_guests') }}" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="reservation_date" id="reservation_date" class="form-control caldera-input" 
                                    min="{{ $minDate ?? date('Y-m-d') }}" max="{{ $maxDate ?? date('Y-m-d', strtotime('+30 days')) }}" 
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="special_requests" class="form-control caldera-input" 
                                          rows="3" placeholder="Example: baby chair, non-smoking area, vegetarian preference, etc.">{{ old('special_requests') }}</textarea>
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const oldTimeValue = '{{ old("reservation_time") }}';
