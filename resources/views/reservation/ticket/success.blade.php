...
@section('title', 'Pembelian Tiket Berhasil')
            ...
            <div class="card border-0 shadow-lg text-center">
                <div class="card-body p-5">
                    ...
                    <div class="bg-light rounded-3 p-4 mb-4">
                        ...
                        <h3 class="fw-bold text-primary mb-0">{{ $ticket->ticket_code }}</h3>
                    </div>
                    ...
                    <div class="text-start mb-4">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <p class="fw-bold mb-0">{{ $ticket->customer_name }}</p>
                            </div>
                            <div class="col-md-6 mb-2">
                                <span class="text-muted">Tanggal Kunjungan:</span>
                                <p class="fw-bold mb-0">{{ \Carbon\Carbon::parse($ticket->visit_date)->format('d F Y') }}</p>
                            </div>
                            <div class="col-md-6 mb-2">
                                <span class="text-muted">Jenis Tiket:</span>
                                <p class="fw-bold mb-0">{{ ucfirst($ticket->ticket_type) }}</p>
                            </div>
                            <div class="col-md-6 mb-2">
                                <span class="text-muted">Jumlah:</span>
                                <p class="fw-bold mb-0">{{ $ticket->number_of_tickets }} tiket</p>
                            </div>
                            <div class="col-md-12">
                                <span class="text-muted">Total Pembayaran:</span>
                                <p class="fw-bold text-primary mb-0">Rp {{ number_format($ticket->total_amount, 0, ',', '.') }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex gap-3 justify-content-center">
                        <a href="{{ route('reservation.ticket.view', $ticket->ticket_code) }}" class="btn btn-outline-primary">
                            <i class="fas fa-eye me-2"></i> Lihat Detail
                        </a>
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#paymentModal">
                            <i class="fas fa-upload me-2"></i> Upload Bukti Bayar
                        </button>
                        <a href="{{ route('branding.home') }}" class="btn btn-secondary">
