...
<div class="report-page-header">
    ...
    <a href="<?php echo e(route('admin.reservations.export')); ?>" class="btn-export">
            ...
            <table class="table report-table" id="reservationsTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo e(route('admin.reservations.show', $reservation)); ?>" class="btn btn-view">
                            ...
                            <?php if($reservation->status == 'pending'): ?>
                                ...
                                <button onclick="showCancelModal(<?php echo e($reservation->id); ?>)" class="btn btn-cancel-row ms-1">
