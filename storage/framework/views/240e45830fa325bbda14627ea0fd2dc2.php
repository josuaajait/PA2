    ...
    <div class="col-md-8 mx-auto">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Edit Menu: <?php echo e($menu->name); ?></h4>
            </div>
            <div class="card-body">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('price', $menu->price)); ?>" required>
                            </div>
...
unset($__errorArgs, $__bag); ?>" rows="4" required><?php echo e(old('description', $menu->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <?php if($menu->image): ?>
                            <div class="mb-2">
                                <img src="<?php echo e(asset('storage/' . $menu->image)); ?>" width="150" height="150" style="object-fit: cover; border-radius: 8px;">
                            </div>
                        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="form-check">
                                <input type="checkbox" name="is_available" class="form-check-input" value="1" <?php echo e(old('is_available', $menu->is_available) ? 'checked' : ''); ?>>
                                <label class="form-check-label">Available</label>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="form-check">
                                <input type="checkbox" name="is_recommended" class="form-check-input" value="1" <?php echo e(old('is_recommended', $menu->is_recommended) ? 'checked' : ''); ?>>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" name="sort_order" class="form-control" value="<?php echo e(old('sort_order', $menu->sort_order)); ?>">
                    </div>
