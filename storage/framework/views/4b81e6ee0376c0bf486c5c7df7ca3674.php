...
<?php $__env->startSection('title', 'Testimonials - Caldera Resto & Pool'); ?>
    ...
    <div class="mt-5">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div class="text-muted small">
                Showing <?php echo e($testimonials->firstItem() ?? 0); ?> to <?php echo e($testimonials->lastItem() ?? 0); ?>

                of <?php echo e($testimonials->total()); ?> reviews
            </div>
            <div class="pagination-wrapper">
                <?php echo e($testimonials->appends(request()->query())->links('pagination::bootstrap-5')); ?>
