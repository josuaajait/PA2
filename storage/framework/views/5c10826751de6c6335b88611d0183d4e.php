    ...
    <div class="col-md-4">
        <div class="card h-100 report-card">
            <div class="card-body text-center p-4">
                ...
                <a href="<?php echo e(route('admin.reports.tickets')); ?>" class="btn btn-report">
    ...
    <div class="col-md-4">
        <div class="card h-100 report-card">
            <div class="card-body text-center p-4">
                ...
                <a href="<?php echo e(route('admin.reports.reservations')); ?>" class="btn btn-report">
                    <i class="fas fa-chart-line me-1"></i>Lihat Laporan
                </a>
            </div>
        </div>
    ...
    <div class="col-md-4">
        <div class="card h-100 report-card">
            <div class="card-body text-center p-4">
                ...
                <a href="<?php echo e(route('admin.reports.income')); ?>" class="btn btn-report">
                    <i class="fas fa-chart-line me-1"></i>Lihat Laporan
                </a>
            </div>
        </div>
