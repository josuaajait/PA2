...
<div class="card-container">
    <div class="card">
        <div class="card-header-custom">
            ...
            <span class="email-badge"><?php echo e($email); ?></span>
        </div>
        ...
        <div class="card-body-custom">
            ...
            <form method="POST" action="<?php echo e(route('password.otp.reset')); ?>" id="reset-form">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="otp-inputs">
                        <?php for($i = 0; $i < 6; $i++): ?>
                            <input
                                type="text"
                                maxlength="1"
                                class="otp-digit <?php echo e($errors->has('otp') ? 'is-invalid' : ''); ?>"
                                inputmode="numeric"
                                autocomplete="off"
                            >
                        <?php endfor; ?>
                    </div>
                    <input type="hidden" name="otp" id="otp-hidden" value="<?php echo e(old('otp')); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="resend-text">
                Tidak dapat kode?
                <a href="<?php echo e(route('password.request')); ?>">Kirim ulang OTP</a>
            </div>
...
</html><?php /**PATH D:\xampp\htdocs\PA2_Kel6\resources\views/auth/reset-password-otp.blade.php ENDPATH**/ ?>