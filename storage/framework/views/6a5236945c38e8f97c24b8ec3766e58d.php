<nav class="navbar navbar-expand-lg w-100" id="mainNav" 
    ...
    <div class="container">
        <a class="navbar-brand fw-bold" href="<?php echo e(route('branding.home')); ?>" style="font-size: 1.5rem; transition: color 0.3s ease;">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-center">
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('branding.home')); ?>" style="font-weight: 500; padding: 0.5rem 1rem;">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('branding.about')); ?>" style="font-weight: 500; padding: 0.5rem 1rem;">About</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('branding.menu')); ?>" style="font-weight: 500; padding: 0.5rem 1rem;">Menu</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('branding.pool')); ?>" style="font-weight: 500; padding: 0.5rem 1rem;">Pool</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('branding.promos')); ?>" style="font-weight: 500; padding: 0.5rem 1rem;">Promos</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('branding.gallery')); ?>" style="font-weight: 500; padding: 0.5rem 1rem;">Gallery</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('branding.testimonials')); ?>" style="font-weight: 500; padding: 0.5rem 1rem;">Testimonials</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('branding.contact')); ?>" style="font-weight: 500; padding: 0.5rem 1rem;">Contact</a>
                </li>
                ...
                <?php if(auth()->guard()->check()): ?>
                    <?php if(Auth::user()->role == 'customer'): ?>
                        <li class="nav-item">
                            <a href="<?php echo e(route('reservation.table')); ?>" class="btn btn-primary ms-2" style="background: #667eea; border: none; padding: 0.5rem 1.2rem; border-radius: 8px;">
                    ...
                    <?php else: ?>
                        ...
                        <li class="nav-item dropdown ms-2">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li><a class="dropdown-item" href="<?php echo e(route('customer.reservations')); ?>">
                                    <i class="fas fa-calendar-alt me-2"></i>My Reservations
                                </a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('customer.tickets')); ?>">
                ...
                <?php else: ?>
                    ...
                    <li class="nav-item ms-2">
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-primary" style="border-radius: 8px; padding: 0.5rem 1.2rem;">
                            <i class="fas fa-sign-in-alt me-2"></i>Login
                        </a>
                    </li>
                    <li class="nav-item ms-2">
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-primary" style="background: #667eea; border: none; border-radius: 8px; padding: 0.5rem 1.2rem;">
