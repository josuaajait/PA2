    ...
    <div class="mt-5">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div class="text-muted small">
                Showing <?php echo e($menus->firstItem() ?? 0); ?> to <?php echo e($menus->lastItem() ?? 0); ?>

                of <?php echo e($menus->total()); ?> items
            </div>
            <div class="pagination-wrapper">
                <?php echo e($menus->appends(request()->query())->links('pagination::bootstrap-5')); ?>
