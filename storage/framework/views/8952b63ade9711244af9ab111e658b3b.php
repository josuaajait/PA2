...
<?php $__env->startSection('title', 'Material Kit 2 Pro - Landing Page Interaktif'); ?>
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto text-center text-white">
                ...
                <div class="d-flex justify-content-center gap-3 flex-wrap">
                    <a href="<?php echo e(route('reservation.table')); ?>" class="btn btn-lg bg-gradient-primary px-5 py-3 hover-lift" 
                       style="min-width: 180px;">
                        <i class="fas fa-calendar-alt me-2"></i>Book a Table
                    </a>
                    <a href="<?php echo e(route('reservation.ticket')); ?>" class="btn btn-lg btn-outline-light px-5 py-3 hover-lift" 
...
<div class="container" style="margin-top: -5rem; position: relative; z-index: 10;">
    <div class="row g-4">
        ...
        <?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-3 col-md-6 fade-in-up" style="animation-delay: <?php echo e($index * 0.1); ?>s">
                <div class="card border-0 shadow-lg h-100 hover-lift" style="border-radius: 1rem; background: white;">
                    <div class="card-body text-center p-4">
                        <div class="stats-number" id="<?php echo e($stat['id']); ?>">0</div>
                        <p class="fw-bold mb-3"><?php echo e($stat['label']); ?></p>
                        <div class="icon-circle bg-<?php echo e($stat['color']); ?> bg-opacity-10 mx-auto" 
                             style="width: 60px; height: 60px; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                            <i class="fas <?php echo e($stat['icon']); ?> text-<?php echo e($stat['color']); ?>" style="font-size: 1.8rem;"></i>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="row g-4">
    ...
    <?php $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-md-4 fade-in-up" style="animation-delay: <?php echo e($index * 0.1); ?>s">
            <div class="card feature-card h-100 p-4 hover-lift border-0 shadow-sm" 
                 onclick="showFeature('<?php echo e($feature['feature']); ?>')"
                ...
                <div class="icon-circle bg-gradient-<?php echo e($feature['gradient']); ?> mx-auto mb-4"
                    ...
                    <i class="fas <?php echo e($feature['icon']); ?> text-white" style="font-size: 2rem;"></i>
                </div>
                
                <h4 class="fw-bold mb-3 text-center" style="color: #333;"><?php echo e($feature['title']); ?></h4>
                <p class="text-secondary mb-4 text-center" style="line-height: 1.6;"><?php echo e($feature['description']); ?></p>
                
                <span class="text-<?php echo e($feature['gradient']); ?> fw-bold mt-auto d-flex justify-content-center align-items-center" style="gap: 0.5rem; transition: gap 0.3s ease;">
                        ...
                        <div class="carousel-item <?php echo e($index === 0 ? 'active' : ''); ?>">
                            <div class="card border-0 shadow-sm mx-auto" style="max-width: 700px; border-radius: 20px;">
                                <div class="card-body p-5 text-center">
                                    ...
                                    <!-- Quote -->
                                    <p class="text-secondary mb-4" style="font-size: 1.1rem; line-height: 1.6;">"<?php echo e($testimonial['quote']); ?>"</p>
...
<div class="cta-section text-white text-center my-5 p-5" style="border-radius: 2rem; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
    ...
    <div class="d-flex justify-content-center gap-3 flex-wrap">
        <a href="<?php echo e(route('reservation.table')); ?>" class="btn btn-light btn-lg px-5 py-3 hover-lift" 
           style="border-radius: 50px; font-weight: 600;">
            <i class="fas fa-calendar-alt me-2"></i>Book a Table
        </a>
        <a href="<?php echo e(route('reservation.ticket')); ?>" class="btn btn-outline-light btn-lg px-5 py-3 hover-lift" 
