        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm caldera-card">
                ...
                <div class="card-body p-4 p-lg-5">
                    ...
                    <form action="<?php echo e(route('branding.testimonials.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PA_03\PA2\resources\views/pages/testimonials-create.blade.php ENDPATH**/ ?>