...
<div class="report-page-header">
    <div class="d-flex align-items-center gap-3">
        ...
        <span class="booking-code-badge"><?php echo e($reservation->booking_code); ?></span>
    </div>
    <a href="<?php echo e(route('admin.reservations.index')); ?>" class="btn-back">
...
<div class="card report-main-card">
    <div class="card-body">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
                ...
                <table class="detail-table">
                    <tr>
                        <td>Kode Booking</td>
                        <td><span class="fw-bold" style="color:#1c3451;"><?php echo e($reservation->booking_code); ?></span></td>
                    </tr>
                    <tr>
                        <td>Tanggal</td>
                    ...
                    <tr>
                        <td>Down Payment</td>
                        <td><span class="fw-bold" style="color:#c1a067; font-size:15px;">Rp <?php echo e(number_format($reservation->down_payment ?? 50000, 0, ',', '.')); ?></span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span class="payment-badge <?php echo e($paymentClass); ?>">
                                <i class="fas <?php echo e($paymentIcon); ?> me-1"></i>
                    ...
                    <tr>
                        <td>Alasan Batal</td>
                        <td class="text-danger"><?php echo e($reservation->cancellation_reason); ?></td>
                    </tr>
                    <?php endif; ?>
                </table>
            </div>
        ...
        <div class="text-center">
            <img src="<?php echo e(asset('storage/' . $reservation->payment_proof)); ?>" 
                 alt="Bukti Pembayaran" 
                 class="proof-image" 
                 style="max-width: 300px; cursor: pointer;"
                 onclick="openProofModal('<?php echo e(asset('storage/' . $reservation->payment_proof)); ?>')">
            <div class="mt-2">
        ...
        <?php if($reservation->payment_status == 'payment_verified' && $reservation->status == 'pending'): ?>
            <div class="text-end d-flex justify-content-end gap-2">
                ...
                <button onclick="showCancelModal(<?php echo e($reservation->id); ?>)" class="btn-cancel-main">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\PA2_Kel6\resources\views/admin/reservations/show.blade.php ENDPATH**/ ?>