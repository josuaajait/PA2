...
<?php $__env->startSection('title', 'Tambah Promo'); ?>
...
<div class="card border-0 shadow-sm">
    ...
    <div class="card-body">
        <form action="<?php echo e(route('admin.promos.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('promo_code')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select name="promo_type" class="form-control <?php $__errorArgs = ['promo_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="text-end">
                <a href="<?php echo e(route('admin.promos.index')); ?>" class="btn btn-secondary">Batal</a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\PA2_Kel6\resources\views/admin/promos/create.blade.php ENDPATH**/ ?>