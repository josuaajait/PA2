    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-nav">
            <nav class="nav flex-column">
                ...
                <a href="<?php echo e(route('admin.promos.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.promos.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('admin.galleries.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.galleries.*') ? 'active' : ''); ?>">
...
</html><?php /**PATH D:\xampp\htdocs\PA2_Kel6\resources\views/layouts/admin.blade.php ENDPATH**/ ?>