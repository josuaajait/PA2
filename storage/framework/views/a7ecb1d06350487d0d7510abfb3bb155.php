...
<?php $__env->startSection('title', 'Detail Testimoni'); ?>
...
<div class="report-page-header">
    ...
    <a href="<?php echo e(route('admin.testimonials.index')); ?>" class="btn-back">
        ...
        <div class="row justify-content-center">
            <div class="col-md-7">
                ...
                <div class="text-center mb-2">
                    ...
                    <div class="testimonial-name"><?php echo e($testimonial->customer_name); ?></div>
                    <div class="testimonial-email"><?php echo e($testimonial->customer_email); ?></div>
                </div>
                ...
                <div class="info-row">
                    ...
                    <span><?php echo e(\Carbon\Carbon::parse($testimonial->visit_date)->format('d M Y')); ?></span>
                </div>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\PA2_Kel6\resources\views/admin/testimonials/show.blade.php ENDPATH**/ ?>