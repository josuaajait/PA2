          ...
          <div class="col-8">
            <div class="numbers">
              ...
              <h5 class="font-weight-bolder mb-0">
                <?php echo e($stats['today_reservations'] ?? 0); ?>
        ...
        <div class="row">
          <div class="col-8">
            <div class="numbers">
              ...
              <h5 class="font-weight-bolder mb-0">
                <?php echo e($stats['today_tickets'] ?? 0); ?>
        ...
        <div class="row">
          <div class="col-8">
            <div class="numbers">
              ...
              <h5 class="font-weight-bolder mb-0">
                Rp <?php echo e(number_format($stats['today_income'] ?? 0, 0, ',', '.')); ?>
        ...
        <div class="row">
          <div class="col-8">
            <div class="numbers">
              ...
              <h5 class="font-weight-bolder mb-0">
                <?php echo e($stats['pending_reservations'] ?? 0); ?>
        ...
        <div class="row">
          <div class="col-8">
            <div class="numbers">
              ...
              <h5 class="font-weight-bolder mb-0">
                <?php echo e($stats['total_tickets_sold'] ?? 0); ?>
        ...
        <div class="row">
          <div class="col-8">
            <div class="numbers">
              ...
              <h5 class="font-weight-bolder mb-0">
                Rp <?php echo e(number_format($stats['total_ticket_income'] ?? 0, 0, ',', '.')); ?>
        ...
        <div class="row">
          <div class="col-8">
            <div class="numbers">
              ...
              <h5 class="font-weight-bolder mb-0">
                Rp <?php echo e(number_format($stats['avg_ticket_price'] ?? 0, 0, ',', '.')); ?>
        ...
        <div class="row">
          <div class="col-8">
            <div class="numbers">
              ...
              <h5 class="font-weight-bolder mb-0">
                <?php echo e($stats['pending_payments'] ?? 0); ?>
      ...
      <div class="card-body p-3">
        <div class="list-group">
          ...
          <div class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
            ...
            <div class="d-flex">
              <div class="d-flex gap-2">
                <span class="badge bg-primary">Adult: <?php echo e(\App\Models\PoolTicket::where('ticket_type', 'adult')->count()); ?></span>
                <span class="badge bg-info">Child: <?php echo e(\App\Models\PoolTicket::where('ticket_type', 'child')->count()); ?></span>
                <span class="badge bg-success">Family: <?php echo e(\App\Models\PoolTicket::where('ticket_type', 'family')->count()); ?></span>
              </div>
            </div>
          </div>
          ...
          <div class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
            ...
            <div class="d-flex">
              <h4 class="mb-0 font-weight-bolder"><?php echo e($stats['pending_testimonials'] ?? 0); ?></h4>
            </div>
          </div>
      ...
      <div class="card-body px-0 pt-0 pb-2">
        <div class="table-responsive p-0">
          <table class="table align-items-center mb-0">
            ...
            <tbody>
              <?php $__currentLoopData = \App\Models\PoolTicket::latest()->take(5)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                <td>
                  <div class="d-flex px-2 py-1">
                    <div class="d-flex flex-column justify-content-center">
                      <h6 class="mb-0 text-sm"><?php echo e($ticket->ticket_code); ?></h6>
                    </div>
                  </div>
                </td>
                <td>
                  <p class="text-xs font-weight-bold mb-0"><?php echo e($ticket->customer_name); ?></p>
                  <p class="text-xs text-secondary mb-0"><?php echo e($ticket->customer_phone); ?></p>
                </td>
                <td class="align-middle text-center">
                  <span class="text-secondary text-xs font-weight-bold"><?php echo e($ticket->visit_date->format('d M Y')); ?></span>
                </td>
                <td class="align-middle text-center">
                ...
                <td class="align-middle text-center">
                  <span class="text-secondary text-xs font-weight-bold"><?php echo e($ticket->number_of_tickets); ?></span>
                </td>
                <td class="align-middle text-center">
                  <span class="text-secondary text-xs font-weight-bold">Rp <?php echo e(number_format($ticket->total_amount, 0, ',', '.')); ?></span>
                </td>
                <td class="align-middle text-center text-sm">
                ...
                <td class="align-middle">
                  <a href="<?php echo e(route('admin.tickets.show', $ticket)); ?>" class="btn btn-link text-dark px-3 mb-0">
                    <i class="fas fa-eye text-dark me-2" aria-hidden="true"></i> View
                  </a>
                </td>
              </tr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\PA2_Kel6\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>