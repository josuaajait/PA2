...
<div class="report-page-header">
    ...
    <div class="d-flex gap-2">
        <form action="<?php echo e(route('admin.reports.export-income')); ?>" method="GET" class="d-inline">
        ...
        <a href="<?php echo e(route('admin.reports.index')); ?>" class="btn btn-back">
            ...
            <form method="GET" class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <select name="payment_type" class="form-control">
                        ...
                        <option value="down_payment" <?php echo e(request('payment_type') == 'down_payment' ? 'selected' : ''); ?>>Down Payment (Reservasi)</option>
                        <option value="full_payment" <?php echo e(request('payment_type') == 'full_payment' ? 'selected' : ''); ?>>Full Payment (Tiket)</option>
                    </select>
                </div>
            ...
            <div class="col-md-4">
                <div class="card summary-card primary text-white">
                    <div class="card-body">
                        ...
                        <h3>Rp <?php echo e(number_format($summary['total_income'], 0, ',', '.')); ?></h3>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card summary-card success text-white">
                    <div class="card-body">
                        ...
                        <h3>Rp <?php echo e(number_format($summary['ticket_income'], 0, ',', '.')); ?></h3>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card summary-card info text-white">
                    <div class="card-body">
                        ...
                        <h3>Rp <?php echo e(number_format($summary['reservation_income'], 0, ',', '.')); ?></h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <table class="table report-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($payment->payment_type == 'down_payment'): ?>
                        ...
                        <td><?php echo $payment->payment_status_label; ?></td>
                        <td><small><?php echo e($payment->payment_code); ?></small></td>
                    </tr>
...
<script>
    ...
    new Chart(comparisonCtx, {
        ...
        data: {
            ...
            datasets: [{
                data: [<?php echo e($summary['ticket_income']); ?>, <?php echo e($summary['reservation_income']); ?>],
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\PA2_Kel6\resources\views/admin/reports/income.blade.php ENDPATH**/ ?>